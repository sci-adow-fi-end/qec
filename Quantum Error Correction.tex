...
\begin{center}
	\scalebox{1.5}{
		\begin{quantikz}
			\slice[style=blue, label style={pos=1, anchor=north}]{${\scriptstyle\ket{\psi_{t0}}}$}	& \gate{H}
...
\begin{center}
	\scalebox{1.5}{
		\begin{quantikz}
			...
			&& \targ{} \slice[style=blue, label style={pos=1, anchor=north}]{${\scriptstyle\ket{\psi_{t2}}}$}	&
		\end{quantikz}
	}
\end{center}
\begin{itemize}
