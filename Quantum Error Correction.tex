...
\newtheorem{Error-correction-conditions}{Theorem}
...
an unexpected result it is necessary to introduce some intermediate steps.

\begin{Error-correction-conditions}
...
\end{Error-correction-conditions}
